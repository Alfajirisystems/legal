...
<head>
    ...
    <link
        href="{{ url('assets/vendor_components/perfect-scrollbar-master/css/perfect-scrollbar.css') }}"
        rel='stylesheet' />
    <link href="{{ url('assets/vendor_components/fullcalendar/fullcalendar.min.css' ) }}"
        rel='stylesheet' />

    <!-- Data table css -->
    <link href="{{ url('assets/vendor_components/datatable/datatables.min.css') }}"
        rel='stylesheet' />
...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
    ...
    <div class="wrapper">
            ...
            <div class="d-flex align-items-center logo-box justify-content-start">
                ...
                <a href="/" class="logo">
                    ...
                    <div class="logo-mini w-50">
                        <span class="light-logo"><img src="{{ url('images/logo-letter.png') }}"
                                alt="logo"></span>
                        <span class="dark-logo"><img src="{{ url('images/logo-letter.png') }}"
                                alt="logo"></span>
                    </div>
                    <div class="logo-lg">
        ...
        <footer class="main-footer">
            ...
            </script> <a href="#">Company</a>. All Rights Reserved.
        </footer>
    ...
    <script src="{{ url('assets/vendor_components/apexcharts-bundle/dist/apexcharts.js') }}">
    </script>
